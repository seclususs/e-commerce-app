...
class ProductService:
    """
    Layanan untuk mengelola logika bisnis inti terkait produk (CRUD).
    """
    def create_product(self, form_data, files):
        """Membuat produk baru dan mengembalikan datanya."""
            ...
            with conn:
                ...
                # Skenario 3: Tidak ada perubahan status varian
                    ...
                    if not new_has_variants:
                        ...
                        # For variant products, main product stock is aggregate, don't update from this form
                        stock = product['stock'] # Keep existing aggregate stock
                        weight_grams = 0
                        sku = None
