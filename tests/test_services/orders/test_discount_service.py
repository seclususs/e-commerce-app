...
class TestDiscountService(BaseTestCase):
    ...
    def test_validate_and_calculate_voucher_percent_success(self):
        self.mock_voucher_service.get_active_voucher_by_code.return_value = (
            self.mock_voucher_percent
        )
        
        result = self.discount_service.validate_and_calculate_voucher(
            "TENOFF", 100000
        )
    ...
    def test_validate_and_calculate_voucher_fixed_success(self):
        self.mock_voucher_service.get_active_voucher_by_code.return_value = (
            self.mock_voucher_fixed
        )
    ...
    def test_validate_and_calculate_voucher_not_found(self):
    ...
    def test_validate_and_calculate_voucher_below_min_purchase(self):
        self.mock_voucher_service.get_active_voucher_by_code.return_value = (
            self.mock_voucher_percent
        )
    ...
    def test_validate_and_calculate_voucher_max_uses_reached(self):
    ...
    def test_validate_and_calculate_voucher_expired(self):
    ...
    def test_validate_and_calculate_voucher_invalid_subtotal_format(self):
        with self.assertRaises(ValidationError):
            self.discount_service.validate_and_calculate_voucher(
                "TENOFF", "abc"
            )

    def test_validate_and_calculate_voucher_db_error(self):
